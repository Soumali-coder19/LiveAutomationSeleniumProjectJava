...
public class TC_RF_002 {
	...
	public void verifyConfirmationEmail()  {
		...
		String email = "soumalimukhopadhyay@gmail.com";
		String appPasscode = "uuxi elon dvjd yfoq";
		String link = null;
		
		driver.findElement(By.id("ap_email")).sendKeys("soumalimukhopadhyay@gmail.com");
